...
other info can be downloaded :download:`template.py <../samples/template.py>`

Deployment
----------

A simple way to do it is demonstrated in -- see :ref:`samples.template module`

.. literalinclude:: ../samples/template.py
    :linenos:
    :language: python
    :lines: 12, 14-18
